/**
  ******************************************************************************
  * @file    accelerometer_motion_data.c
...
ai_buffer g_accelerometer_motion_data_map_activations[AI_ACCELEROMETER_MOTION_DATA_ACTIVATIONS_COUNT] = {
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 2168, 1, 1),
    2168, NULL, NULL),    /* heap_overlay_pool */
  };
ai_buffer g_accelerometer_motion_data_map_weights[AI_ACCELEROMETER_MOTION_DATA_WEIGHTS_COUNT] = {
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 105764, 1, 1),
    105764, NULL, s_accelerometer_motion_weights_array_u64),   /* weights_array */
  };
...
ai_buffer ai_accelerometer_motion_data_activations_buffer_get(const ai_handle ptr)
{
  ai_buffer buf = AI_BUFFER_INIT(
    ...
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, AI_ACCELEROMETER_MOTION_DATA_ACTIVATIONS_SIZE, 1, AI_ACCELEROMETER_MOTION_DATA_ACTIVATIONS_COUNT),
    AI_ACCELEROMETER_MOTION_DATA_ACTIVATIONS_SIZE,
    NULL, ptr);
  return buf;
}
...
ai_buffer ai_accelerometer_motion_data_weights_buffer_get(const ai_handle ptr)
{
  ai_buffer buf = AI_BUFFER_INIT(
    ...
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, AI_ACCELEROMETER_MOTION_DATA_WEIGHTS_SIZE, 1, AI_ACCELEROMETER_MOTION_DATA_WEIGHTS_COUNT),
    AI_ACCELEROMETER_MOTION_DATA_WEIGHTS_SIZE,
    NULL, ptr);
  return buf;
}
...
{
  return AI_HANDLE_PTR(g_accelerometer_motion_weights_table);
