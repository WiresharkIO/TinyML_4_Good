/**
  ...
  ******************************************************************************
  */
#ifndef AI_ACCELEROMETER_MOTION_H
#define AI_ACCELEROMETER_MOTION_H

#include "accelerometer_motion_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_ACCELEROMETER_MOTION_MODEL_NAME          "accelerometer_motion"
#define AI_ACCELEROMETER_MOTION_ORIGIN_MODEL_NAME   "model_quantized"

/******************************************************************************/
#define AI_ACCELEROMETER_MOTION_ACTIVATIONS_ALIGNMENT   (4)
#define AI_ACCELEROMETER_MOTION_INPUTS_IN_ACTIVATIONS   (4)
#define AI_ACCELEROMETER_MOTION_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_ACCELEROMETER_MOTION_IN_NUM        (1)

AI_DEPRECATED
#define AI_ACCELEROMETER_MOTION_IN \
  ai_accelerometer_motion_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_ACCELEROMETER_MOTION_IN_SIZE { \
  AI_ACCELEROMETER_MOTION_IN_1_SIZE, \
}
#define AI_ACCELEROMETER_MOTION_IN_SIZE_BYTES { \
  AI_ACCELEROMETER_MOTION_IN_1_SIZE_BYTES, \
}
#define AI_ACCELEROMETER_MOTION_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
...
#define AI_ACCELEROMETER_MOTION_IN_1_SIZE_BYTES  (120)

/******************************************************************************/
#define AI_ACCELEROMETER_MOTION_OUT_NUM       (1)

AI_DEPRECATED
#define AI_ACCELEROMETER_MOTION_OUT \
  ai_accelerometer_motion_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_ACCELEROMETER_MOTION_OUT_SIZE { \
  AI_ACCELEROMETER_MOTION_OUT_1_SIZE, \
}
#define AI_ACCELEROMETER_MOTION_OUT_SIZE_BYTES { \
  AI_ACCELEROMETER_MOTION_OUT_1_SIZE_BYTES, \
}
#define AI_ACCELEROMETER_MOTION_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_ACCELEROMETER_MOTION_OUT_1_CHANNEL     (1)
#define AI_ACCELEROMETER_MOTION_OUT_1_SIZE        (1)
#define AI_ACCELEROMETER_MOTION_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_ACCELEROMETER_MOTION_N_NODES (7)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup accelerometer_motion
 ...
 * @ref ai_accelerometer_motion_create. Both the activations memory buffer 
 ...
 * using @ref ai_accelerometer_motion_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_accelerometer_motion_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_accelerometer_motion_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_ACCELEROMETER_MOTION_*
 * defines into file @ref accelerometer_motion.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_accelerometer_motion_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_ACCELEROMETER_MOTION_H */
